...
<span class="token punctuation">}</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><div class="language-"><pre><code>:::warning 
Requires Experimental
:::
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="using-minecraft-on-death" tabindex="-1">Using minecraft:on_death <a class="header-anchor" href="#using-minecraft-on-death" aria-hidden="true">#</a></h2><p>You can also use the <code>minecraft:on_death</code> component in your <code>entity.json</code> file in the Behavior Pack, which is a fairly easy way to accomplish a command on death.</p><p>You first add it to your components and make it run an event on self;</p><div class="language-"><pre><code>&quot;minecraft:on_death&quot; : {
          &quot;event&quot; : &quot;wiki:on_death&quot;,
          &quot;target&quot; : &quot;self&quot;
           }
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><div class="language-"><pre><code>:::tip 
You can add scores and tags to the entity even when it is dead using this method.

:::
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div>`,9);function q(_,y,v,g,f,w){const p=o("BButton"),e=o("CodeHeader");return i(),l("div",null,[n(p,{color:"blue",link:"animation-controllers-intro"},{default:s(()=>[u]),_:1}),d,n(e,null,{default:s(()=>[b]),_:1}),m,n(e,null,{default:s(()=>[k]),_:1}),h])}var A=r(c,[["render",q]]);export{C as __pageData,A as default};
