import{_ as e,r as o,c,a,w as t,e as n,o as r,d as p}from"./404.md.3addfd4f.js";const x='{"title":"Disabling Team-damage","description":"","frontmatter":{"title":"Disabling Team-damage","category":"Tutorials","tags":["intermediate"]},"headers":[{"level":3,"title":"Projectiles","slug":"projectiles"}],"relativePath":"entities/disabling-team-damage.md","lastUpdated":1641238782270}',l={},u=n("",1),i=p("BP/entities/player.json#components"),k=n(`__VP_STATIC_START__<div class="language-json line-numbers-mode"><pre><code><span class="token property">&quot;minecraft:damage_sensor&quot;</span><span class="token operator">:</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div>__VP_STATIC_END__`,1),d=p("BP/entities/arrow.json"),_=n(`__VP_STATIC_START__<div class="language-json line-numbers-mode"><pre><code>
<span class="token comment">//&quot;components&quot;</span>
