import{_ as r,r as a,c as l,a as t,w as p,b as s,d as n,e as c,o as i}from"./404.md.00614ce5.js";const B='{"title":"Respawn Commands","description":"","frontmatter":{"title":"Respawn Commands","tags":["recipe"]},"headers":[],"relativePath":"animation-controllers/respawn-commands.md","lastUpdated":1643131803072}',u={},m=n("Learn more about Animation Controllers"),b=s("p",null,"This animation controller can be used to run commands, such as re-adding potion effects or giving items when the player respawns.",-1),k=s("p",null,[n("Simply add the animation controller to the "),s("code",null,"player.json"),n(", and")],-1),d=n("BP/animation_controllers/respawn.ac.json"),_=c(`<div class="language-json line-numbers-mode"><pre><code><span class="token punctuation">{</span>
