import{_ as e,r as o,c as r,a,w as t,e as n,o as l,d as p}from"./404.md.7be7b610.js";const S='{"title":"Spawning Tamed Entities","description":"","frontmatter":{"title":"Spawning Tamed Entities","category":"Tutorials","tags":["intermediate"],"mention":["Axelpvz2030"]},"headers":[{"level":2,"title":"Overview","slug":"overview"},{"level":2,"title":"player.json","slug":"player-json"},{"level":2,"title":"pretamed_wolf.json","slug":"pretamed-wolf-json"},{"level":2,"title":"Integrating Item Projectiles (Alternate Method)","slug":"integrating-item-projectiles-alternate-method"}],"relativePath":"entities/spawning-tamed-entities.md","lastUpdated":1642852460099}',c={},u=n('',8),i=p("BP/entities/player.json"),k=n(`__VP_STATIC_START__<div class="language-json line-numbers-mode"><pre><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><p>And now, you can spawn a tamed wolf next to the player with <code>/event entity @p wiki:spawn_tamed_wolf</code>. You can also spawn it with a <code>wiki:pretamed_wolf</code> spawn egg by setting <code>is_spawnable</code> to <code>true</code>!</p><h2 id="integrating-item-projectiles-alternate-method" tabindex="-1">Integrating Item Projectiles (Alternate Method) <a class="header-anchor" href="#integrating-item-projectiles-alternate-method" aria-hidden="true">#</a></h2><p>Introduced as one of <a href="/items/items-16.html">1.16&#39;s experimental item features</a>, the <code>shoot</code> event property can be used to make projectiles that transform into tamed entities upon impact.</p>__VP_STATIC_END__`,4),d=p("BP/items/throwable_pretamed_wolf.json"),q=n(`__VP_STATIC_START__<div class="language-json line-numbers-mode"><pre><code><span class="token punctuation">{</span>
