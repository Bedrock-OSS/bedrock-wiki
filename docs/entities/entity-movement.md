...
| Component                                                                                                        | Note                             |
| ---------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| [minecraft:movement](/entities/vanilla-usage-components-3.html#movement)                                         | Set movement speed (required)    |
| [minecraft:underwater_movement](/entities/vanilla-usage-components-4.html#underwater-movement)                   | Set movement speed in the water. |
| [minecraft:flying_speed](/entities/vanilla-usage-components-2.html#flying-speed)                                 | Set the speed in the air.        |
