...
::: tip
This tutorial assumes you have a basic understanding of entities, loot tables, and Blockbench. Make sure to check out the [tutorial](/legacy-guide/custom-entity-full) on entities, the [tutorial](/legacy-guide/loot_tables-recipes-spawn_rules) on loot tables and the [tutorial](/guide/blockbench) on blockbench before starting this tutorial.
:::
