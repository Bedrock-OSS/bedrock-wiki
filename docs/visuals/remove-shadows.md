...
You can also add the [custom hit test component](https://bedrock.dev/docs/stable/Entities#minecraft:custom_hit_test). The `custom_hit_test` component will allow you to hit and interact with the entity. The `custom_hit_test` will not create a shadow.
