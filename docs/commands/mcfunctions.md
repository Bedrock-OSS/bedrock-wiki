...
<Card image="/assets/images/commands/mcfunctions/bcc-logo.png" title="Download" link="https://github.com/Bedrock-OSS/bedrock-examples/releases/download/download/functions_sample.mcpack">
