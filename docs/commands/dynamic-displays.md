...
<CodeHeader path="BP/functions/wiki/rawtext/display_logic.mcfunction" />
    ...
    "rawtext": [
        {
            ...
            "with": {
                "rawtext": [
                    { "score": { "name": "*", "objective": "wiki:array" } },
                        ...
                        "rawtext": [
                            {
                                ...
                                "with": {
                                    "rawtext": [
                                        { "score": { "name": "*", "objective": "wiki:element" } },
                                        { "text": "Shelf: 1, Book: 1" },
                                        { "text": "Shelf: 1, Book: 2" },
                                        { "text": "Shelf: 1, Book: 3" },
                                        { "text": "Shelf: 1, Book: 4" },
...
<CodeHeader path="BP/functions/wiki/scoreboard/players/set_all.mcfunction" />
...
<CodeHeader path="BP/functions/wiki/event/world/on_initialise.mcfunction" />
...
<CodeHeader path="BP/functions/wiki/rawtext/display/1.mcfunction" />
...
<CodeHeader path="BP/functions/wiki/rawtext/display/2.mcfunction" />
...
<CodeHeader path="BP/functions/wiki/rawtext/display/3.mcfunction" />
