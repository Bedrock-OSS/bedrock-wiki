...
| clips_children            |       boolean        |    `false`    | Cuts off visually and interactively everything beyond the boundaries of the UI element                                                                                                             |
...
| focus_change_down            |                                                    string                                                     |               | Identifier (`focus_identifier`) of the focusable element that will receive focus when on button.menu_down. If you want to prevent the focus to escape from the bottom use `FOCUS_OVERRIDE_STOP` |
| focus_change_up              |                                                    string                                                     |               | Identifier (`focus_identifier`) of the focusable element that will receive focus when on button.menu_up. If you want to prevent the focus to escape from the top use `FOCUS_OVERRIDE_STOP`      |
| focus_change_left            |                                                    string                                                     |               | Identifier (`focus_identifier`) of the focusable element that will receive focus when on button.menu_left. If you want to prevent the focus to escape from the left use `FOCUS_OVERRIDE_STOP`   |
| focus_change_right           |                                                    string                                                     |               | Identifier (`focus_identifier`) of the focusable element that will receive focus when on button.menu_right. If you want to prevent the focus to escape from the right use `FOCUS_OVERRIDE_STOP` |
| focus_mapping                |                                                     array                                                     |               |                                                                                                                                                                                                 |
...
And there are some must toggles in setting and inventory,even though you can not get a warning without dev version and open the assert diagnosis,they exactly exist and controlled by a function called _ScreenView::\_passViewCommand::<lambda_6d65fd272578d43f1becb6eada4ff32c>::()::<lambda_2ab071547c9a470558c54e4d3cddb5f2>::operator()_,when you totally modify these screens,you may meet this assertion.
...
| scroll_box_and_track_panel | string  |               | Name of child UI element that will contain the scrolling and track controls                       |
...
The blue box top left point is in the top middle point of the parent element. As for the black box, the right middle point is in the center of the parent.
...
| to                        |               | The final value of the property affected by this animation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
