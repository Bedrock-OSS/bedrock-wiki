...
| resolve_sibling_scope     | boolean |               | If `true`, only allows the selection of a sibling element in the same control and blocks all the control names outside the sibling scope, for `source_control_name`                                                  |
