...
<WikiImage src="A_splash_text_example.png" caption="A splash text example" width="300" />
...
<WikiImage src="A_long_splash_text_example.png" caption="A long splash text example" width="300" />
