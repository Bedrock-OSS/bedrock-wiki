...
### Replacing pieces
In order to replace pieces you can go and edit the template pools for the Trail Ruins and remove the piece you want to replace. You can then rebuild the piece and add the vanilla jigsaw block settings to that piece and add it to the structure to make it generate.
