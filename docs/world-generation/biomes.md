...
<CodeHeader path="biomes/plains.json" />
...
<CodeHeader path="biomes/ocean.json" />
...
<CodeHeader path="biomes/deep_ocean.json" />
...
<CodeHeader path="biomes/mangrove_forest.json" />

```json
"hills_transformation": "mangrove_forest_hills"
```

<CodeHeader path="biomes/mangrove_forest_hills.json" />
...
<CodeHeader path="biomes/ivory_shallows.json" />
...
<CodeHeader path="biomes/lava_fields.json" />
...
<CodeHeader path="biomes/savanna_mutated.json" />
...
<CodeHeader path="biomes/highlands.json" />
...
<CodeHeader path="biomes/highlands_forest.json" />
