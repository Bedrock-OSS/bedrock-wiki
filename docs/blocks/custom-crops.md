...
<Spoiler title="Custom Crop Geometry">

<ExampleFile path="RP/models/blocks/crop.geo.json" />
...
<ExampleFile path="BP/scripts/custom_crop.js" />
...
<ExampleFile path="BP/loot_tables/blocks/custom_crop_young.json" />

### Mature Crop Loot Table

<ExampleFile path="BP/loot_tables/blocks/custom_crop_mature.json" />
...
<Button link="/blocks/custom-crops.zip" download="Custom Crops.mcaddon">
    Download MCADDON
</Button>
