...
Solution: Use a [JSON linter](https://jsoning.com/validator/) and double check that your identifier didn't change. Ensure that your block has `minecraft:geometry` and `minecraft:material_instances`, or an `RP/blocks.json` textures entry.
