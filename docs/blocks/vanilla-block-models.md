...
| <WikiImage src="/assets/images/blocks/vanilla-block-models/full_block.png" alt="" width="100" /> | `minecraft:geometry.full_block` | When used for a block with the `"opaque"`{lang=json} render method, a shadow is cast onto surrounding blocks and adjacent block faces are culled.                                                                                                                                                                                                                                           |
