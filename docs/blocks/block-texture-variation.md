...
When using texture variation with the [material instances](/blocks/block-components#material-instances) component, ensure that the `format_version` in your pack manifest is 1.21.120 or higher.
:::
